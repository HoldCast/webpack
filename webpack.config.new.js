...
module.exports = {
    ...
    output: {
        ...
        path: path.resolve(__dirname, 'build'), //__dirname:项目根目录;path.resolve:将参数__dirname位置的字符,解析到一个绝对路径(build)里。
        publicPath: './',
    ...
    plugins: [
        ...
        /*new htmlWebpackPlugin({
            template: __dirname + '/public/index.html'    //通过这个模板生成index.html
        })*/
    ],
    //配置本地服务器
    devServer: {
